	...
	public class BlockTableTests {
		...
		public void Block_table_is_read_correctly() {
			using(var archive = TestArchiveFactory.OpenTestArchive1()) {
				...
				Assert.That(table[0].Flags, Is.EqualTo(0x81000200));
				...
				Assert.That(table[1].Flags, Is.EqualTo(0x81000200));
				...
				Assert.That(table[2].Flags, Is.EqualTo(0x81000200));
				...
				Assert.That(table[3].Flags, Is.EqualTo(0x81000200));
				...
				Assert.That(table[4].Flags, Is.EqualTo(0x81000200));
				...
				Assert.That(table[5].Flags, Is.EqualTo(0x81000200));
				...
				Assert.That(table[6].Flags, Is.EqualTo(0x81000200));
				...
				Assert.That(table[7].Flags, Is.EqualTo(0x81000200));
				...
				Assert.That(table[8].Flags, Is.EqualTo(0x81000200));
				...
				Assert.That(table[9].Flags, Is.EqualTo(0x81000200));
			}
		}
	}
}